...
conf_parser.add_argument('--dataset', type=str,default="bookcrossing",required = False)
...
conf_parser.add_argument('--learning_rate', default=0.0001, type=float)
conf_parser.add_argument('--decay_rate', default=0.8, type=float)
...
conf_parser.add_argument('--drop_keep_prob', default=0.9, type=float)
...
conf_parser.add_argument('--USER_EMBEDDING_SIZE', type=int,default=128,required = False)
conf_parser.add_argument('--ITEM_EMBEDDING_SIZE', type=int,default=32,required = False)
conf_parser.add_argument('--OTHER_EMBEDDING_SIZE', type=int,default=64,required = False)
