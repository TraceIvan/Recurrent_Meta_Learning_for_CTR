...
conf_parser.add_argument('--epochs', default=100, type=int)
conf_parser.add_argument('--batch_size', default=128, type=int)
conf_parser.add_argument('--loss_weight_alpha', type=float,default=0.4,required = False)
conf_parser.add_argument('--USER_EMBEDDING_SIZE', type=int,default=64,required = False)
conf_parser.add_argument('--ITEM_EMBEDDING_SIZE', type=int,default=128,required = False)
conf_parser.add_argument('--OTHER_EMBEDDING_SIZE', type=int,default=16,required = False)
conf_parser.add_argument('--LSTM_1', type=int,default=32,required = False)
